...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT(
		...
		KC_CTAB,  KC_A,     KC_S,     KC_D,   KC_F,    KC_G,          KC_H,   KC_J,     KC_K, KC_L,    KC_SCLN, KC_CQOT,
		KC_LSFT,  KC_Z,     KC_X,     KC_C,   KC_V,    KC_B,          MO(3),  KC_N,     KC_M, KC_COMM, KC_DOT,  KC_SLSH, KC_SHNT,
		KC_LCTL,  KC_LALT,                    KC_LGUI, LT(1, KC_BSPC),LT(2, KC_SPC),    KC_RGUI,                KC_RALT, KC_RCTL
    ),
    ...
    LAYOUT(
		KC_ESC,   KC_1,      KC_2,      KC_3,      KC_4,       KC_5,             KC_6,      KC_7,     KC_8,    KC_9,    KC_0,      XXXXXXX,  XXXXXXX,
		KC_DEL,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,    XXXXXXX,          KC_LEFT,   KC_DOWN,  KC_UP,   KC_RGHT, XXXXXXX,   XXXXXXX,
