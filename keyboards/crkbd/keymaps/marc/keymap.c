...
#define BSPC LT(_LOWER, KC_BSPC)
#define SPC LT(_RAISE, KC_SPC)
...
[_QWERTY] = LAYOUT(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, SENT,
                               KC_LALT, KC_LGUI, BSPC,    SPC,     KC_RGUI, KC_RCTL
),

[_LOWER] = LAYOUT(
    KC_ESC,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, _______, _______, KC_PIPE,
    KC_DEL,  _______, _______, _______, _______, _______, _______, KC_LCBR, KC_EQL,  KC_RCBR, _______, _______,
