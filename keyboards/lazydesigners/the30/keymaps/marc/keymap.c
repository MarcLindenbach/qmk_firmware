...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_ortho_3x10(
    ...
    KC_TAB,    KC_ESC,  XXXXXXX, XXXXXXX, RESET,   XXXXXXX, KC_MINS, XXXXXXX, KC_QUES, KC_QUOT,
    KC_LPRN,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_UNDS, XXXXXXX, KC_SLSH, KC_RPRN
  ),
