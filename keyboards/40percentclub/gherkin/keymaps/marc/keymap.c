...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_ortho_3x10(
    ...
    KC_TAB,    KC_ESC,  XXXXXXX, XXXXXXX, RESET,   XXXXXXX, KC_GRV,  KC_MINS, KC_QUES, KC_QUOT,
    KC_LPRN,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_TILD,  KC_UNDS, KC_SLSH, KC_RPRN
  ),
  ...
  [_RAISE] = LAYOUT_ortho_3x10(
    ...
    KC_BSLS, KC_LCBR, KC_EQL,  KC_RCBR, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_DQT,
    KC_PIPE, KC_LBRC, KC_PLUS, KC_RBRC, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_ENT
  )
};
